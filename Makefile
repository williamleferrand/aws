...
install-all:
	ocamlfind install aws META _build/lib/aws.o  _build/lib/aws.cm* _build/lib/aws-ocsigen.cm*

install-cohttp:
	ocamlfind install aws META _build/lib/aws.o _build/lib/*.cmi _build/lib/aws.cm*
