...
(* OASIS_START *)
(* DO NOT EDIT (digest: 748b9004bf79fd6db07c44df04ee3d89) *)
(*
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_byteopt = [(OASISExpr.EBool true, ["-annot"])];
                      bs_nativeopt = [(OASISExpr.EBool true, ["-annot"])];
                      },
                   {
                      lib_modules =
                        [
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = "tools";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "aws-cohttp"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
